function waning_crescent_moon(){
    ...
    path.cubicCurveTo([10.379, 22.938], [8.133, 18.496], [8.133, 14.0]);
    path.cubicCurveTo([8.133, 9.504], [10.379, 5.062], [14.0, 2.398]);
    path.closePath();
    path.moveTo([14.0, 1.199]);
    return {name:"waning_crescent_moon",width:28, height:28,path:path};
}
